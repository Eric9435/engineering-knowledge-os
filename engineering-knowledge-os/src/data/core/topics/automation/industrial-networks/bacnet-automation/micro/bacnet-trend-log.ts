export const bacnet_automation_014 = {
  id: "bacnet-trend-log",
  title: "BACnet Trend Log",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "BACnet Trend Log field-level meaning", "Sensors, actuators and wiring"],
...
`
...

    {
      ...
      body: `
BACnet Trend Log ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
BACnet Trend Log ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
