export const bacnet_automation_006 = {
  id: "analog-input-object",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Analog Input Object field-level meaning", "Sensors, actuators and wiring"],
  ...
  sections: [
    {
      title: "Analog Input Object ဆိုတာဘာလဲ",
...
`
...

    {
      ...
      body: `
Analog Input Object ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Analog Input Object ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
