export const profinet_ethernet_ip_017 = {
  id: "industrial-network-security",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Industrial Network Security field-level meaning", "Sensors, actuators and wiring"],
  ...
  sections: [
    {
      title: "Industrial Network Security ဆိုတာဘာလဲ",
...
`
...

    {
      ...
      body: `
Industrial Network Security ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Industrial Network Security ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
