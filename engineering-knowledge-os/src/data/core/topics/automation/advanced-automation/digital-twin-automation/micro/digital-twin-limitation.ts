export const digital_twin_automation_015 = {
  id: "digital-twin-limitation",
  title: "Digital Twin Limitation",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Digital Twin Limitation field-level meaning", "Sensors, actuators and wiring"],
...
`
...

    {
      ...
      body: `
Digital Twin Limitation ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Digital Twin Limitation ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
