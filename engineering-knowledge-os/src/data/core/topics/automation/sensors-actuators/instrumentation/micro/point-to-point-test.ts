export const instrumentation_012 = {
  id: "point-to-point-test",
  title: "Point To Point Test",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Point To Point Test field-level meaning", "Sensors, actuators and wiring"],
...
`
...

    {
      ...
      body: `
Point To Point Test ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Point To Point Test ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
