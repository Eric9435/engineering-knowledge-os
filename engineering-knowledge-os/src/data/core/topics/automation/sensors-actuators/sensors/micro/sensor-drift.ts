export const sensors_019 = {
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Sensor Drift field-level meaning", "Sensors, actuators and wiring"],
  ...
  sections: [
    {
      title: "Sensor Drift ဆိုတာဘာလဲ",

      body: `
Sensor Drift သည် Automation Engineering ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Automation ဆိုတာ sensor data ကိုဖတ်ပြီး controller logic ဖြင့် decision ချကာ actuator/equipment များကို command ပေးပြီး system ကို safe, stable, efficient and reliable ဖြစ်အောင်လုပ်သော engineering discipline ဖြစ်သည်။
...
`
...

    {
      ...
      body: `
Professional Automation Engineer တစ်ယောက်အတွက် Sensor Drift ကိုနားလည်ခြင်းဆိုတာ PLC code line တစ်ကြောင်းသိတာမဟုတ်ပါ။ Sensor signal ဘယ်လိုဝင်သလဲ၊ scaling ဘယ်လိုလုပ်သလဲ၊ logic ဘယ်လိုရေးသလဲ၊ interlock ဘယ်လိုကာကွယ်သလဲ၊ alarm ဘယ်လိုထုတ်သလဲ၊ HMI မှာ operator ကိုဘယ်လိုပြသသလဲဆိုတာကို system thinking နဲ့နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Sensor Drift ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Sensor Drift ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
