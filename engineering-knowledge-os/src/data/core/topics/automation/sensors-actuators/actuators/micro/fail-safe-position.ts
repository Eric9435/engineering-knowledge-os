export const actuators_014 = {
  id: "fail-safe-position",
  title: "Fail Safe Position",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Fail Safe Position field-level meaning", "Sensors, actuators and wiring"],
  ...
  sections: [
    {
      title: "Fail Safe Position ဆိုတာဘာလဲ",
...
`
...

    {
      ...
      body: `
Fail Safe Position ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Fail Safe Position ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
