export const trends_and_alarms_004 = {
  id: "trend-sampling",
  title: "Trend Sampling",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Trend Sampling field-level meaning", "Sensors, actuators and wiring"],
  ...
  sections: [
    {
      title: "Trend Sampling ဆိုတာဘာလဲ",
...
`
...

    {
      ...
      body: `
Trend Sampling ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Trend Sampling ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
