export const energy_optimization_control_010 = {
  id: "pump-energy-optimization",
  title: "Pump Energy Optimization",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Pump Energy Optimization field-level meaning", "Sensors, actuators and wiring"],
  ...
  sections: [
    {
      title: "Pump Energy Optimization ဆိုတာဘာလဲ",
...
`
...

    {
      ...
      body: `
Pump Energy Optimization ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Pump Energy Optimization ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
