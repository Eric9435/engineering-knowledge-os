export const chiller_plant_automation_auto_013 = {
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Condenser Water Reset field-level meaning", "Sensors, actuators and wiring"],
...
`
...

    {
      ...
      body: `
Condenser Water Reset ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Condenser Water Reset ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
