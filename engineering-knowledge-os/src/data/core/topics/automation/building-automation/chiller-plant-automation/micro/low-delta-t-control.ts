export const chiller_plant_automation_auto_015 = {
  id: "low-delta-t-control",
  title: "Low Delta T Control",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Low Delta T Control field-level meaning", "Sensors, actuators and wiring"],
...
`
...

    {
      ...
      body: `
Low Delta T Control ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Low Delta T Control ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
