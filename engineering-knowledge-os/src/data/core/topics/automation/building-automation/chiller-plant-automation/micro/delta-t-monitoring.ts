export const chiller_plant_automation_auto_012 = {
  id: "delta-t-monitoring",
  title: "Delta T Monitoring",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Delta T Monitoring field-level meaning", "Sensors, actuators and wiring"],
  ...
  sections: [
    {
      title: "Delta T Monitoring ဆိုတာဘာလဲ",
...
`
...

    {
      ...
      body: `
Delta T Monitoring ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Delta T Monitoring ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
