export const chiller_plant_automation_auto_009 = {
  id: "lead-lag-chiller",
  title: "Lead Lag Chiller",
  ...
  table: {
    ...
    rows: [
      ["Field Layer", "Lead Lag Chiller field-level meaning", "Sensors, actuators and wiring"],
...
`
...

    {
      ...
      body: `
Lead Lag Chiller ကို real project ထဲမှာအသုံးချရာတွင် PLC, DDC, SCADA, HMI, BMS, Modbus, BACnet, PROFINET, Ethernet/IP, sensors, actuators, VFDs and control panels တို့နဲ့ချိတ်ဆက်နားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Lead Lag Chiller ကို troubleshoot လုပ်ရာတွင် physical device, wiring, power supply, signal value, controller input, logic condition, output command, communication status, HMI display, alarm history and trend data တို့ကို step-by-step စစ်ရမည်။
