export const lighting_system_004 = {
  id: "led-lighting",
  title: "LED Lighting",
  ...
  table: {
    ...
    rows: [
      ["Power", "LED Lighting in electrical engineering system", "Electrical operation"],
  ...
  sections: [
    {
      title: "LED Lighting ဆိုတာဘာလဲ",

      body: `
LED Lighting သည် Electrical Engineering ထဲတွင် အရေးကြီးသော professional engineering micro topic တစ်ခုဖြစ်သည်။ Modern electrical systems များတွင် power generation, transformation, distribution, protection, monitoring and control systems များကို integrated engineering architecture အဖြစ်အသုံးပြုသည်။
...
`
...

    {
      ...
      body: `
Professional Electrical Engineer တစ်ယောက်အတွက် LED Lighting ကိုနားလည်ခြင်းဆိုတာ theory တင်မဟုတ်ပါ။ Real engineering systems ထဲတွင် voltage stability, current flow, fault condition, protection coordination, operational reliability and energy efficiency တို့ကိုနားလည်ရမည်။
...
`
...

    {
      ...
      body: `
LED Lighting ကို troubleshoot လုပ်ရာတွင် voltage, current, frequency, insulation resistance, breaker status, relay trip, harmonic level, thermal condition and load behavior တို့ကိုစစ်ရမည်။
