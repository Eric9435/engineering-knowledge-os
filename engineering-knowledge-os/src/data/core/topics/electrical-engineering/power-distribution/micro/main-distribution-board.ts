export const power_distribution_005 = {
  id: "main-distribution-board",
  ...
  table: {
    ...
    rows: [
      ["Power", "Main Distribution Board in electrical engineering system", "Electrical operation"],
...
`
...

    {
      ...
      body: `
Professional Electrical Engineer တစ်ယောက်အတွက် Main Distribution Board ကိုနားလည်ခြင်းဆိုတာ theory တင်မဟုတ်ပါ။ Real engineering systems ထဲတွင် voltage stability, current flow, fault condition, protection coordination, operational reliability and energy efficiency တို့ကိုနားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Main Distribution Board ကို troubleshoot လုပ်ရာတွင် voltage, current, frequency, insulation resistance, breaker status, relay trip, harmonic level, thermal condition and load behavior တို့ကိုစစ်ရမည်။
