export const electrical_testing_001 = {
  id: "electrical-testing-overview",
  title: "Electrical Testing Overview",
  ...
  table: {
    ...
    rows: [
      ["Power", "Electrical Testing Overview in electrical engineering system", "Electrical operation"],
...
`
...

    {
      ...
      body: `
Professional Electrical Engineer တစ်ယောက်အတွက် Electrical Testing Overview ကိုနားလည်ခြင်းဆိုတာ theory တင်မဟုတ်ပါ။ Real engineering systems ထဲတွင် voltage stability, current flow, fault condition, protection coordination, operational reliability and energy efficiency တို့ကိုနားလည်ရမည်။
...
`
...

    {
      ...
      body: `
Electrical Testing Overview ကို troubleshoot လုပ်ရာတွင် voltage, current, frequency, insulation resistance, breaker status, relay trip, harmonic level, thermal condition and load behavior တို့ကိုစစ်ရမည်။
