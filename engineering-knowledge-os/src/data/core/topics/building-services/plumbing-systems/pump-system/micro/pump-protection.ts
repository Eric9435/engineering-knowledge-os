export const pump_system_015 = {
  ...
  table: {
    ...
    rows: [
      ["System", "Pump Protection in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Pump Protection ဆိုတာဘာလဲ",
      body: `
...
`
    },
    {
      ...
      body: `
Pump Protection ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
