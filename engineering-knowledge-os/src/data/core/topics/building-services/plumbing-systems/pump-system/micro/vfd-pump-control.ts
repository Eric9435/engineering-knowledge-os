export const pump_system_013 = {
  id: "vfd-pump-control",
  title: "VFD Pump Control",
  flow: [
    "Water Source",
    "Pipe Network",
    "Pressure / Flow",
  ...
  table: {
    ...
    rows: [
      ["System", "VFD Pump Control in plumbing system", "Building services design"],
...
`
    },
    {
      ...
      body: `
VFD Pump Control ကို design phase မှာ demand calculation, pipe sizing, pressure zoning, pump selection, tank sizing, valve location, access planning and coordination drawing တို့နဲ့ချိတ်ရမည်။ Site installation phase မှာ pipe material, slope, support, insulation, valve orientation, testing, flushing and commissioning ကိုစစ်ရမည်။
...
`
    },
    {
      ...
      body: `
VFD Pump Control ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
