export const hot_water_supply_003 = {
  id: "calorifier",
  title: "Calorifier",
  flow: [
    "Water Source",
  ...
  table: {
    ...
    rows: [
      ["System", "Calorifier in plumbing system", "Building services design"],
...
`
    },
    {
      ...
      body: `
Calorifier ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
