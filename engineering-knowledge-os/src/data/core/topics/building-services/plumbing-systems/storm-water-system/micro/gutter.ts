export const storm_water_system_004 = {
  id: "gutter",
  title: "Gutter",
  flow: [
    "Water Source",
  ...
  table: {
    ...
    rows: [
      ["System", "Gutter in plumbing system", "Building services design"],
...
`
    },
    {
      ...
      body: `
Professional Building Services Engineer တစ်ယောက်အတွက် Gutter ကိုနားလည်ခြင်းဆိုတာ drawing ထဲမှာ pipe route တွေ့တာမဟုတ်ပါ။ Water ဘယ်ကလာသလဲ၊ pressure ဘယ်လိုထိန်းသလဲ၊ pipe size ဘယ်လိုရွေးသလဲ၊ pump head ဘယ်လိုတွက်သလဲ၊ valve function ဘာလဲ၊ failure ဖြစ်ရင် ဘာ symptom ပေါ်သလဲဆိုတာကို system thinking နဲ့သိရပါမယ်။
...
`
    },
    {
      ...
      body: `
Gutter ကို design phase မှာ demand calculation, pipe sizing, pressure zoning, pump selection, tank sizing, valve location, access planning and coordination drawing တို့နဲ့ချိတ်ရမည်။ Site installation phase မှာ pipe material, slope, support, insulation, valve orientation, testing, flushing and commissioning ကိုစစ်ရမည်။
...
`
    },
    {
      ...
      body: `
Gutter ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
