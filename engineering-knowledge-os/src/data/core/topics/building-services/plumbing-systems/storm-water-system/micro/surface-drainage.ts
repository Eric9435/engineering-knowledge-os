export const storm_water_system_010 = {
  id: "surface-drainage",
  ...
  table: {
    ...
    rows: [
      ["System", "Surface Drainage in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Surface Drainage ဆိုတာဘာလဲ",
      body: `
...
`
    },
    {
      ...
      body: `
Surface Drainage ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
