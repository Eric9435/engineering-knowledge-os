export const storm_water_system_011 = {
  id: "flood-prevention",
  ...
  table: {
    ...
    rows: [
      ["System", "Flood Prevention in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Flood Prevention ဆိုတာဘာလဲ",
      body: `
...
`
    },
    {
      ...
      body: `
Flood Prevention ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
