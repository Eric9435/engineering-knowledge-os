export const storm_water_system_015 = {
  id: "clogging-problem",
  title: "Clogging Problem",
  flow: [
    "Water Source",
    "Pipe Network",
    "Pressure / Flow",
  ...
  table: {
    ...
    rows: [
      ["System", "Clogging Problem in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Clogging Problem ဆိုတာဘာလဲ",
      body: `
...
`
    },
    {
      ...
      body: `
Clogging Problem ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
