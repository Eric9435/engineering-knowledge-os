export const storm_water_system_002 = {
  ...
  table: {
    ...
    rows: [
      ["System", "Rainfall Intensity in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Rainfall Intensity ဆိုတာဘာလဲ",
      body: `
...
`
    },
    {
      ...
      body: `
Rainfall Intensity ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
