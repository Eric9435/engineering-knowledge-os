export const cold_water_supply_009 = {
  id: "pressurized-supply",
  title: "Pressurized Supply",
  flow: [
    "Water Source",
    "Pipe Network",
    "Pressure / Flow",
  ...
  table: {
    ...
    rows: [
      ["System", "Pressurized Supply in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Pressurized Supply ဆိုတာဘာလဲ",
      body: `
...
`
    },
    {
      ...
      body: `
Pressurized Supply ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
