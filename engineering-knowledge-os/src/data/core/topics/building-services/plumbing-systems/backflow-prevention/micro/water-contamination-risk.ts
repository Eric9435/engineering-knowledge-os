export const backflow_prevention_010 = {
  id: "water-contamination-risk",
  ...
  table: {
    ...
    rows: [
      ["System", "Water Contamination Risk in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Water Contamination Risk ဆိုတာဘာလဲ",
      body: `
Water Contamination Risk သည် Building Services Plumbing System ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Plumbing system ဆိုတာ building ထဲသို့ clean water supply ပေးခြင်း၊ hot water distribution လုပ်ခြင်း၊ used water and sewage ကို safely discharge လုပ်ခြင်း၊ storm water ကို control လုပ်ခြင်းတို့ကိုပေါင်းစပ်ထားသော engineering system ဖြစ်သည်။
...
`
    },
    {
      ...
      body: `
Water Contamination Risk ကို design phase မှာ demand calculation, pipe sizing, pressure zoning, pump selection, tank sizing, valve location, access planning and coordination drawing တို့နဲ့ချိတ်ရမည်။ Site installation phase မှာ pipe material, slope, support, insulation, valve orientation, testing, flushing and commissioning ကိုစစ်ရမည်။
...
`
    },
    {
      ...
      body: `
Water Contamination Risk ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
