export const backflow_prevention_008 = {
  id: "vacuum-breaker",
  ...
  table: {
    ...
    rows: [
      ["System", "Vacuum Breaker in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Vacuum Breaker ဆိုတာဘာလဲ",
      body: `
...
`
    },
    {
      ...
      body: `
Vacuum Breaker ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
