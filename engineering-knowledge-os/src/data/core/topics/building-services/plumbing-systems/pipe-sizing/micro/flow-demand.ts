export const pipe_sizing_003 = {
  ...
  table: {
    ...
    rows: [
      ["System", "Flow Demand in plumbing system", "Building services design"],
...
`
    },
    {
      ...
      body: `
Flow Demand ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
