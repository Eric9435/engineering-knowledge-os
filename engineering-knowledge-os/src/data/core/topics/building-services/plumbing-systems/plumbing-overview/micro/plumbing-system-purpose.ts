export const plumbing_overview_001 = {
  id: "plumbing-system-purpose",
  title: "Plumbing System Purpose",
  flow: [
    "Water Source",
    "Pipe Network",
    "Pressure / Flow",
  ...
  table: {
    ...
    rows: [
      ["System", "Plumbing System Purpose in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Plumbing System Purpose ဆိုတာဘာလဲ",
      body: `
Plumbing System Purpose သည် Building Services Plumbing System ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Plumbing system ဆိုတာ building ထဲသို့ clean water supply ပေးခြင်း၊ hot water distribution လုပ်ခြင်း၊ used water and sewage ကို safely discharge လုပ်ခြင်း၊ storm water ကို control လုပ်ခြင်းတို့ကိုပေါင်းစပ်ထားသော engineering system ဖြစ်သည်။
...
`
    },
    {
      ...
      body: `
Plumbing System Purpose ကို design phase မှာ demand calculation, pipe sizing, pressure zoning, pump selection, tank sizing, valve location, access planning and coordination drawing တို့နဲ့ချိတ်ရမည်။ Site installation phase မှာ pipe material, slope, support, insulation, valve orientation, testing, flushing and commissioning ကိုစစ်ရမည်။
...
`
    },
    {
      ...
      body: `
Plumbing System Purpose ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
