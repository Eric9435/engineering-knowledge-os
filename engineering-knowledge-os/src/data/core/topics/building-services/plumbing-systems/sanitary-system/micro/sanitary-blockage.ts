export const sanitary_system_014 = {
  id: "sanitary-blockage",
  title: "Sanitary Blockage",
  flow: [
    "Water Source",
    "Pipe Network",
    "Pressure / Flow",
  ...
  table: {
    ...
    rows: [
      ["System", "Sanitary Blockage in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Sanitary Blockage ဆိုတာဘာလဲ",
      body: `
...
`
    },
    {
      ...
      body: `
Sanitary Blockage ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
