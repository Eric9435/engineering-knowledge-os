export const sanitary_system_012 = {
  id: "sewage-pump",
  title: "Sewage Pump",
  flow: [
    "Water Source",
  ...
  table: {
    ...
    rows: [
      ["System", "Sewage Pump in plumbing system", "Building services design"],
...
`
    },
    {
      ...
      body: `
Sewage Pump ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
