export const sanitary_system_013 = {
  id: "odor-problem",
  title: "Odor Problem",
  flow: [
    "Water Source",
  ...
  table: {
    ...
    rows: [
      ["System", "Odor Problem in plumbing system", "Building services design"],
...
`
    },
    {
      ...
      body: `
Odor Problem ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
