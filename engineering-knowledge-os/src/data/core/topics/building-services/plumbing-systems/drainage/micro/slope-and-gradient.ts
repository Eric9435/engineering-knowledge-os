export const drainage_010 = {
  id: "slope-and-gradient",
  title: "Slope and Gradient",
  flow: [
    "Water Source",
    "Pipe Network",
    "Pressure / Flow",
  ...
  table: {
    ...
    rows: [
      ["System", "Slope and Gradient in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Slope and Gradient ဆိုတာဘာလဲ",
      body: `
...
`
    },
    {
      ...
      body: `
Slope and Gradient ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
