export const drainage_014 = {
  id: "blockage-diagnosis",
  ...
  table: {
    ...
    rows: [
      ["System", "Blockage Diagnosis in plumbing system", "Building services design"],
  ...
  sections: [
    {
      title: "Blockage Diagnosis ဆိုတာဘာလဲ",
      body: `
...
`
    },
    {
      ...
      body: `
Blockage Diagnosis ကို troubleshoot လုပ်ရာတွင် symptom ကိုအရင်ကြည့်ရမည်။ Low pressure လား၊ no water လား၊ leakage လား၊ blockage လား၊ odor လား၊ overflow လား၊ pump trip လား၊ backflow risk လားဆိုတာခွဲရမည်။
