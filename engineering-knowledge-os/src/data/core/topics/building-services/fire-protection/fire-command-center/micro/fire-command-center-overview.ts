export const fire_command_center_001 = {
  id: "fire-command-center-overview",
  title: "Fire Command Center Overview",
  ...
  table: {
    ...
    rows: [
      ["Protection", "Fire Command Center Overview in fire protection system", "Building fire safety"],
  ...
  sections: [
    {
      title: "Fire Command Center Overview ဆိုတာဘာလဲ",

      body: `
Fire Command Center Overview သည် Building Fire Protection Engineering ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Fire protection system ဆိုတာ building အတွင်း fire detection, fire alarm, smoke control, evacuation support and fire suppression ကိုပေါင်းစပ်ထားသော life safety engineering system ဖြစ်သည်။
...
`
...

    {
      ...
      body: `
Fire Command Center Overview ကို troubleshoot လုပ်ရာတွင် fire panel status, detector signal, pressure reading, pump status, fan operation, damper position, alarm history, loop fault, cable continuity and equipment response တို့ကိုစစ်ရမည်။
