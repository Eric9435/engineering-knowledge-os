export const fire_command_center_016 = {
  id: "command-center-maintenance",
  title: "Command Center Maintenance",
  ...
  table: {
    ...
    rows: [
      ["Protection", "Command Center Maintenance in fire protection system", "Building fire safety"],
  ...
  sections: [
    {
      title: "Command Center Maintenance ဆိုတာဘာလဲ",

      body: `
Command Center Maintenance သည် Building Fire Protection Engineering ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Fire protection system ဆိုတာ building အတွင်း fire detection, fire alarm, smoke control, evacuation support and fire suppression ကိုပေါင်းစပ်ထားသော life safety engineering system ဖြစ်သည်။
...
`
...

    {
      ...
      body: `
Command Center Maintenance ကို troubleshoot လုပ်ရာတွင် fire panel status, detector signal, pressure reading, pump status, fan operation, damper position, alarm history, loop fault, cable continuity and equipment response တို့ကိုစစ်ရမည်။
