export const fire_suppression_011 = {
  id: "pre-discharge-alarm",
  title: "Pre-Discharge Alarm",
  ...
  table: {
    ...
    rows: [
      ["Protection", "Pre-Discharge Alarm in fire protection system", "Building fire safety"],
  ...
  sections: [
    {
      title: "Pre-Discharge Alarm ဆိုတာဘာလဲ",

      body: `
Pre-Discharge Alarm သည် Building Fire Protection Engineering ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Fire protection system ဆိုတာ building အတွင်း fire detection, fire alarm, smoke control, evacuation support and fire suppression ကိုပေါင်းစပ်ထားသော life safety engineering system ဖြစ်သည်။
...
`
...

    {
      ...
      body: `
Pre-Discharge Alarm ကို troubleshoot လုပ်ရာတွင် fire panel status, detector signal, pressure reading, pump status, fan operation, damper position, alarm history, loop fault, cable continuity and equipment response တို့ကိုစစ်ရမည်။
