export const fire_suppression_004 = {
  id: "co2-suppression",
  title: "CO2 Suppression",
  ...
  table: {
    ...
    rows: [
      ["Protection", "CO2 Suppression in fire protection system", "Building fire safety"],
  ...
  sections: [
    {
      title: "CO2 Suppression ဆိုတာဘာလဲ",

      body: `
CO2 Suppression သည် Building Fire Protection Engineering ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Fire protection system ဆိုတာ building အတွင်း fire detection, fire alarm, smoke control, evacuation support and fire suppression ကိုပေါင်းစပ်ထားသော life safety engineering system ဖြစ်သည်။
...
`
...

    {
      ...
      body: `
CO2 Suppression ကို troubleshoot လုပ်ရာတွင် fire panel status, detector signal, pressure reading, pump status, fan operation, damper position, alarm history, loop fault, cable continuity and equipment response တို့ကိုစစ်ရမည်။
