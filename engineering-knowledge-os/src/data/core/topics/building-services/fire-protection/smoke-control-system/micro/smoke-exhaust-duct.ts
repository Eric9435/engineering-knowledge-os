export const smoke_control_system_010 = {
  id: "smoke-exhaust-duct",
  title: "Smoke Exhaust Duct",
  ...
  table: {
    ...
    rows: [
      ["Protection", "Smoke Exhaust Duct in fire protection system", "Building fire safety"],
  ...
  sections: [
    {
      title: "Smoke Exhaust Duct ဆိုတာဘာလဲ",

      body: `
Smoke Exhaust Duct သည် Building Fire Protection Engineering ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Fire protection system ဆိုတာ building အတွင်း fire detection, fire alarm, smoke control, evacuation support and fire suppression ကိုပေါင်းစပ်ထားသော life safety engineering system ဖြစ်သည်။
...
`
...

    {
      ...
      body: `
Smoke Exhaust Duct ကို troubleshoot လုပ်ရာတွင် fire panel status, detector signal, pressure reading, pump status, fan operation, damper position, alarm history, loop fault, cable continuity and equipment response တို့ကိုစစ်ရမည်။
