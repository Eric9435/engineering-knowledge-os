export const ductAir_024 = {
  ...
  table: {
    ...
    rows: [
      ["Airflow", "Air Throw affects air movement", "Comfort and ventilation design"],
  ...
  sections: [
    {
      title: "Air Throw ဆိုတာဘာလဲ",
      body: `
Air Throw သည် HVAC duct and air distribution system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Duct system ဆိုတာ conditioned air, return air, fresh air, exhaust air တို့ကို building အတွင်း သတ်မှတ်ထားသော zone များသို့ပို့ဆောင်ပေးသော air pathway ဖြစ်သည်။
...
`
    },
    {
      ...
      body: `
Air Throw ကို troubleshoot လုပ်ရာတွင် airflow measurement, duct pressure reading, damper position, filter condition, fan speed, duct leakage, diffuser condition, noise source, vibration source and balancing report တို့ကိုစစ်ရမည်။
