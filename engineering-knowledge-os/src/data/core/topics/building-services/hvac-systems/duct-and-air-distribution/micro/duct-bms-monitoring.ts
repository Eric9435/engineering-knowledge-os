export const ductAir_046 = {
  id: "duct-bms-monitoring",
  title: "Duct BMS Monitoring",
  flow: [
    "Air Source",
    "Duct Path",
    "Pressure Loss",
  ...
  table: {
    ...
    rows: [
      ["Airflow", "Duct BMS Monitoring affects air movement", "Comfort and ventilation design"],
  ...
  sections: [
    {
      title: "Duct BMS Monitoring ဆိုတာဘာလဲ",
      body: `
Duct BMS Monitoring သည် HVAC duct and air distribution system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Duct system ဆိုတာ conditioned air, return air, fresh air, exhaust air တို့ကို building အတွင်း သတ်မှတ်ထားသော zone များသို့ပို့ဆောင်ပေးသော air pathway ဖြစ်သည်။
...
`
    },
    {
      ...
      body: `
Duct BMS Monitoring ကို troubleshoot လုပ်ရာတွင် airflow measurement, duct pressure reading, damper position, filter condition, fan speed, duct leakage, diffuser condition, noise source, vibration source and balancing report တို့ကိုစစ်ရမည်။
