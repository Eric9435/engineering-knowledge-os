export const ductAir_005 = {
  id: "exhaust-air-duct",
  title: "Exhaust Air Duct",
  flow: [
    "Air Source",
    "Duct Path",
    "Pressure Loss",
  ...
  table: {
    ...
    rows: [
      ["Airflow", "Exhaust Air Duct affects air movement", "Comfort and ventilation design"],
  ...
  sections: [
    {
      title: "Exhaust Air Duct ဆိုတာဘာလဲ",
      body: `
Exhaust Air Duct သည် HVAC duct and air distribution system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Duct system ဆိုတာ conditioned air, return air, fresh air, exhaust air တို့ကို building အတွင်း သတ်မှတ်ထားသော zone များသို့ပို့ဆောင်ပေးသော air pathway ဖြစ်သည်။
...
`
    },
    {
      ...
      body: `
Professional Building Services Engineer တစ်ယောက်အတွက် Exhaust Air Duct ကိုနားလည်ခြင်းဆိုတာ duct layout ကြည့်တတ်ရုံမဟုတ်ပါ။ Airflow rate, velocity, static pressure, friction loss, fitting loss, diffuser throw, damper position, balancing requirement, installation quality and commissioning result တို့ကို system thinking နဲ့နားလည်ရမည်။
...
`
    },
    {
      ...
      body: `
Exhaust Air Duct ကို troubleshoot လုပ်ရာတွင် airflow measurement, duct pressure reading, damper position, filter condition, fan speed, duct leakage, diffuser condition, noise source, vibration source and balancing report တို့ကိုစစ်ရမည်။
