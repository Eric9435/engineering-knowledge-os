export const coolingLoad_111 = {
  id: "energyplus-concepts",
  title: "EnergyPlus Concepts",
  flow: [
    "Heat Source",
    "Heat Gain",
    "Load Calculation",
  ...
  table: {
    ...
    rows: [
      ["Concept", "EnergyPlus Concepts ရဲ့အဓိကအဓိပ္ပါယ်", "HVAC cooling load analysis"],
  ...
  sections: [
    {
      title: "EnergyPlus Concepts ဆိုတာဘာလဲ",
      body: `
EnergyPlus Concepts သည် HVAC Cooling Load engineering ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ Cooling load ဆိုတာ building သို့ room တစ်ခုကို desired indoor condition မှာထိန်းထားဖို့ remove လုပ်ရမည့် heat amount ဖြစ်သည်။
...
`
    },
    {
      ...
      body: `
Professional HVAC engineer အတွက် EnergyPlus Concepts ကိုနားလည်ခြင်းဆိုတာ load calculation table ထဲမှာ number တစ်ခုထည့်တာမဟုတ်ပါ။ ဒီ load က ဘယ် source ကလာသလဲ၊ sensible load လား latent load လား၊ peak condition မှာဘယ်လိုပြောင်းလဲသလဲ၊ AHU/FCU/chiller size ကိုဘယ်လိုသက်ရောက်သလဲဆိုတာကိုနားလည်ရပါမယ်။
...
`
    },
    {
      ...
      body: `
EnergyPlus Concepts ကို design phase, commissioning phase, operation phase, troubleshooting phase, optimization phase အားလုံးမှာအသုံးချနိုင်သည်။ Building type, occupancy schedule, outdoor weather, solar exposure, wall/glass properties, equipment load, ventilation requirement, humidity condition တို့ကိုအတူတူစဉ်းစားရသည်။
