export const ahuFcu_033 = {
  id: "vibration-and-noise",
  ...
  table: {
    ...
    rows: [
      ["Air Side", "Vibration and Noise relation to airflow and comfort", "AHU / FCU analysis"],
  ...
  sections: [
    {
      title: "Vibration and Noise ဆိုတာဘာလဲ",
      body: `
Vibration and Noise သည် HVAC air-side system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ AHU နှင့် FCU systems များသည် building zone များထဲသို့ conditioned air ပို့ပေးပြီး thermal comfort, humidity control, ventilation and indoor air quality ကိုထိန်းပေးသည်။
...
`
    },
    {
      ...
      body: `
Vibration and Noise ကို troubleshoot လုပ်တဲ့အခါ symptom → sensor reading → command signal → actuator response → physical condition → trend data ဆိုတဲ့ order နဲ့စစ်ရပါမယ်။
