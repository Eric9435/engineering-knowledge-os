export const ahuFcu_020 = {
  ...
  table: {
    ...
    rows: [
      ["Air Side", "Static Pressure Control relation to airflow and comfort", "AHU / FCU analysis"],
  ...
  sections: [
    {
      ...
      body: `
Static Pressure Control သည် HVAC air-side system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ AHU နှင့် FCU systems များသည် building zone များထဲသို့ conditioned air ပို့ပေးပြီး thermal comfort, humidity control, ventilation and indoor air quality ကိုထိန်းပေးသည်။
...
`
    },
    {
      ...
      body: `
Static Pressure Control ကို troubleshoot လုပ်တဲ့အခါ symptom → sensor reading → command signal → actuator response → physical condition → trend data ဆိုတဲ့ order နဲ့စစ်ရပါမယ်။
