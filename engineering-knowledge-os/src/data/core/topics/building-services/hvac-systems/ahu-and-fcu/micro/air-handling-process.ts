export const ahuFcu_003 = {
  id: "air-handling-process",
  title: "Air Handling Process",
  flow: [
    "Air Condition",
    "AHU / FCU Component",
    "Sensor Feedback",
  ...
  table: {
    ...
    rows: [
      ["Air Side", "Air Handling Process relation to airflow and comfort", "AHU / FCU analysis"],
  ...
  sections: [
    {
      title: "Air Handling Process ဆိုတာဘာလဲ",
      body: `
Air Handling Process သည် HVAC air-side system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ AHU နှင့် FCU systems များသည် building zone များထဲသို့ conditioned air ပို့ပေးပြီး thermal comfort, humidity control, ventilation and indoor air quality ကိုထိန်းပေးသည်။
...
`
    },
    {
      ...
      body: `
Air Handling Process ကို troubleshoot လုပ်တဲ့အခါ symptom → sensor reading → command signal → actuator response → physical condition → trend data ဆိုတဲ့ order နဲ့စစ်ရပါမယ်။
