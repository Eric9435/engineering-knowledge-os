export const ahuFcu_047 = {
  id: "testing-and-balancing",
  ...
  table: {
    ...
    rows: [
      ["Air Side", "Testing and Balancing relation to airflow and comfort", "AHU / FCU analysis"],
  ...
  sections: [
    {
      title: "Testing and Balancing ဆိုတာဘာလဲ",
      body: `
Testing and Balancing သည် HVAC air-side system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ AHU နှင့် FCU systems များသည် building zone များထဲသို့ conditioned air ပို့ပေးပြီး thermal comfort, humidity control, ventilation and indoor air quality ကိုထိန်းပေးသည်။
...
`
    },
    {
      ...
      body: `
Testing and Balancing ကို troubleshoot လုပ်တဲ့အခါ symptom → sensor reading → command signal → actuator response → physical condition → trend data ဆိုတဲ့ order နဲ့စစ်ရပါမယ်။
