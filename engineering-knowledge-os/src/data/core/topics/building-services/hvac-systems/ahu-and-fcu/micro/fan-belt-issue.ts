export const ahuFcu_032 = {
  id: "fan-belt-issue",
  title: "Fan Belt Issue",
  flow: [
    "Air Condition",
    "AHU / FCU Component",
    "Sensor Feedback",
  ...
  table: {
    ...
    rows: [
      ["Air Side", "Fan Belt Issue relation to airflow and comfort", "AHU / FCU analysis"],
  ...
  sections: [
    {
      title: "Fan Belt Issue ဆိုတာဘာလဲ",
      body: `
Fan Belt Issue သည် HVAC air-side system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ AHU နှင့် FCU systems များသည် building zone များထဲသို့ conditioned air ပို့ပေးပြီး thermal comfort, humidity control, ventilation and indoor air quality ကိုထိန်းပေးသည်။
...
`
    },
    {
      ...
      body: `
Fan Belt Issue ကို troubleshoot လုပ်တဲ့အခါ symptom → sensor reading → command signal → actuator response → physical condition → trend data ဆိုတဲ့ order နဲ့စစ်ရပါမယ်။
