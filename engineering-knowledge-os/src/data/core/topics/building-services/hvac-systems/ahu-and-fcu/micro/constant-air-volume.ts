export const ahuFcu_023 = {
  id: "constant-air-volume",
  ...
  table: {
    ...
    rows: [
      ["Air Side", "Constant Air Volume relation to airflow and comfort", "AHU / FCU analysis"],
  ...
  sections: [
    {
      title: "Constant Air Volume ဆိုတာဘာလဲ",
      body: `
Constant Air Volume သည် HVAC air-side system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ AHU နှင့် FCU systems များသည် building zone များထဲသို့ conditioned air ပို့ပေးပြီး thermal comfort, humidity control, ventilation and indoor air quality ကိုထိန်းပေးသည်။
...
`
    },
    {
      ...
      body: `
Constant Air Volume ကို troubleshoot လုပ်တဲ့အခါ symptom → sensor reading → command signal → actuator response → physical condition → trend data ဆိုတဲ့ order နဲ့စစ်ရပါမယ်။
