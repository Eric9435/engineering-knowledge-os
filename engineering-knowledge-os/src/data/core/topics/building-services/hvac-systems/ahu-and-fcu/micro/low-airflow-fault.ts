export const ahuFcu_029 = {
  id: "low-airflow-fault",
  title: "Low Airflow Fault",
  flow: [
    "Air Condition",
    "AHU / FCU Component",
    "Sensor Feedback",
  ...
  table: {
    ...
    rows: [
      ["Air Side", "Low Airflow Fault relation to airflow and comfort", "AHU / FCU analysis"],
  ...
  sections: [
    {
      title: "Low Airflow Fault ဆိုတာဘာလဲ",
      body: `
Low Airflow Fault သည် HVAC air-side system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ AHU နှင့် FCU systems များသည် building zone များထဲသို့ conditioned air ပို့ပေးပြီး thermal comfort, humidity control, ventilation and indoor air quality ကိုထိန်းပေးသည်။
...
`
    },
    {
      ...
      body: `
Low Airflow Fault ကို troubleshoot လုပ်တဲ့အခါ symptom → sensor reading → command signal → actuator response → physical condition → trend data ဆိုတဲ့ order နဲ့စစ်ရပါမယ်။
