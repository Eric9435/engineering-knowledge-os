export const ahuFcu_035 = {
  id: "ahu-bms-integration",
  title: "AHU BMS Integration",
  flow: [
    "Air Condition",
    "AHU / FCU Component",
    "Sensor Feedback",
  ...
  table: {
    ...
    rows: [
      ["Air Side", "AHU BMS Integration relation to airflow and comfort", "AHU / FCU analysis"],
  ...
  sections: [
    {
      title: "AHU BMS Integration ဆိုတာဘာလဲ",
      body: `
AHU BMS Integration သည် HVAC air-side system ထဲတွင်အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ AHU နှင့် FCU systems များသည် building zone များထဲသို့ conditioned air ပို့ပေးပြီး thermal comfort, humidity control, ventilation and indoor air quality ကိုထိန်းပေးသည်။
...
`
    },
    {
      ...
      body: `
AHU BMS Integration ကို troubleshoot လုပ်တဲ့အခါ symptom → sensor reading → command signal → actuator response → physical condition → trend data ဆိုတဲ့ order နဲ့စစ်ရပါမယ်။
