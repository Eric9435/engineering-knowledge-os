export const ats_generator_002 = {
  id: "generator-backup",
  ...
  table: {
    ...
    rows: [
      ["Distribution","Generator Backup in building electrical services","MEP power delivery"],
