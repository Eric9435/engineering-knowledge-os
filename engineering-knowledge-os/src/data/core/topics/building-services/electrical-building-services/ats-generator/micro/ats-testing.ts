export const ats_generator_010 = {
  id: "ats-testing",
  title: "ATS Testing",
  ...
  table: {
    ...
    rows: [
      ["Distribution","ATS Testing in building electrical services","MEP power delivery"],
  ...
  sections: [
    {
      title: "ATS Testing ဆိုတာဘာလဲ",
      body: `
ATS Testing သည် Building Services အောက်ရှိ Electrical Building Services ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ ဒီအပိုင်းသည် general Electrical Engineering theory မဟုတ်ဘဲ building ထဲမှာ power ကို safe, reliable, maintainable ဖြစ်အောင် distribute/control/protect လုပ်တဲ့ MEP electrical system ဖြစ်သည်။
`
    },
    {
