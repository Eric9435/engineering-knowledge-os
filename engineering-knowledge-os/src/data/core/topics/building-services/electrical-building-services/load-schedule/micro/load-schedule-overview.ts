export const load_schedule_001 = {
  id: "load-schedule-overview",
  title: "Load Schedule Overview",
  flow: ["Power Source","Panel / Circuit","Protection","Load","Monitoring","Maintenance"],
  table: {
    headers: ["Layer","Meaning","Building Services Use"],
    rows: [
      ["Distribution","Load Schedule Overview in building electrical services","MEP power delivery"],
  ...
  sections: [
    {
      title: "Load Schedule Overview ဆိုတာဘာလဲ",
      body: `
Load Schedule Overview သည် Building Services အောက်ရှိ Electrical Building Services ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ ဒီအပိုင်းသည် general Electrical Engineering theory မဟုတ်ဘဲ building ထဲမှာ power ကို safe, reliable, maintainable ဖြစ်အောင် distribute/control/protect လုပ်တဲ့ MEP electrical system ဖြစ်သည်။
`
    },
    {
