export const load_schedule_008 = {
  id: "spare-capacity",
  ...
  table: {
    ...
    rows: [
      ["Distribution","Spare Capacity in building electrical services","MEP power delivery"],
  ...
  sections: [
    {
      title: "Spare Capacity ဆိုတာဘာလဲ",
      body: `
Spare Capacity သည် Building Services အောက်ရှိ Electrical Building Services ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ ဒီအပိုင်းသည် general Electrical Engineering theory မဟုတ်ဘဲ building ထဲမှာ power ကို safe, reliable, maintainable ဖြစ်အောင် distribute/control/protect လုပ်တဲ့ MEP electrical system ဖြစ်သည်။
`
    },
    {
