export const low_voltage_distribution_008 = {
  id: "metering",
  title: "Metering",
  ...
  table: {
    ...
    rows: [
      ["Distribution","Metering in building electrical services","MEP power delivery"],
  ...
  sections: [
    {
      title: "Metering ဆိုတာဘာလဲ",
      body: `
Metering သည် Building Services အောက်ရှိ Electrical Building Services ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ ဒီအပိုင်းသည် general Electrical Engineering theory မဟုတ်ဘဲ building ထဲမှာ power ကို safe, reliable, maintainable ဖြစ်အောင် distribute/control/protect လုပ်တဲ့ MEP electrical system ဖြစ်သည်။
`
    },
    {
