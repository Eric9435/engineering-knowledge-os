export const low_voltage_distribution_010 = {
  id: "lv-troubleshooting",
  title: "LV Troubleshooting",
  flow: ["Power Source","Panel / Circuit","Protection","Load","Monitoring","Maintenance"],
  table: {
    headers: ["Layer","Meaning","Building Services Use"],
    rows: [
      ["Distribution","LV Troubleshooting in building electrical services","MEP power delivery"],
  ...
  sections: [
    {
      title: "LV Troubleshooting ဆိုတာဘာလဲ",
      body: `
LV Troubleshooting သည် Building Services အောက်ရှိ Electrical Building Services ထဲတွင် အရေးကြီးသော micro concept တစ်ခုဖြစ်သည်။ ဒီအပိုင်းသည် general Electrical Engineering theory မဟုတ်ဘဲ building ထဲမှာ power ကို safe, reliable, maintainable ဖြစ်အောင် distribute/control/protect လုပ်တဲ့ MEP electrical system ဖြစ်သည်။
`
    },
    {
